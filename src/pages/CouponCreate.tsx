...
export default function CouponCreate() {
    ...
    getCouponById(id)
      .then((data) => {
        ...
        setForm({
          ...
          restaurantId:
            data.restaurantId != null ? String(data.restaurantId) : "",
          ...
          displayOnClientPage: data.displayOnClientPage ?? false,
        });
      })
      .catch((e) => {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const payload: CreateCouponPayload = {
      ...
      displayOnClientPage: form.displayOnClientPage,
    };
          ...
          <FormSaveBarrier canSave={canSave}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="pt-3 border-t border-gray-200 dark:border-slate-700 space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          setForm((s) => ({ ...s, customerId: e.target.value }))
                        }
                      >
              ...
              <Card className="shadow-sm">
                <CardHeader className="pb-3">
                  <CardTitle className="text-lg">
                    {t("common.discountValidity")}
                  </CardTitle>
                  <CardDescription>
                    {t("common.discountValidityDesc")}
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={form.maxUse}
                      onChange={(e) =>
                        setForm((s) => ({ ...s, maxUse: e.target.value }))
                      }
                  ...
                  <div className="flex items-center gap-2 pt-2">
                    ...
                    <Label htmlFor="isActive" className="cursor-pointer">
                      {t("common.activeCoupon")}
                    </Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <Checkbox
                      id="displayOnClientPage"
                      checked={form.displayOnClientPage}
                      onCheckedChange={(checked) =>
                        setForm((s) => ({
                          ...s,
                          displayOnClientPage: !!checked,
                        }))
                      }
                    />
                    <Label
                      htmlFor="displayOnClientPage"
                      className="cursor-pointer"
                    >
                      {t("createForms.displayOnClientPage")}
                    </Label>
                  </div>
                </CardContent>
              </Card>
            ...
            >
              {submitting
                ...
                : editing
                  ...
                  : t("createForms.createCouponButton")}
            </Button>
            <Button
              type="button"
              variant="ghost"
