...
function CouponRow({
  ...
  const scope =
    coupon.customerId != null
      ? t("couponsPage.scopePerCustomer")
      : t("common.general");
  const visibilityLabel = coupon.displayOnClientPage
    ? t("common.yes")
    : t("common.no");

  return (
    <TableRow
      className={isDeleted ? "bg-gray-50 opacity-75 dark:bg-slate-800" : ""}
    >
      <TableCell
        className={isDeleted ? "text-gray-600 dark:text-slate-400" : ""}
      >
      ...
      >
        {coupon.restaurantId == null
          ...
          : (coupon.restaurant?.name ??
            t("common.idDisplay", { id: coupon.restaurantId }))}
      </TableCell>
      <TableCell
        className={isDeleted ? "text-gray-600 dark:text-slate-400" : ""}
      >
        {coupon.customerId == null
          ...
          : (() => {
              ...
              return (
                email ||
                name ||
                t("common.idDisplay", { id: coupon.customerId })
              );
            })()}
      </TableCell>
      <TableCell
        ...
        <TableCell className="text-center">
          {perm("coupons", "update") ? (
            <Button
              ...
              aria-label={
                coupon.isActive ? t("common.deactivate") : t("common.activate")
              }
              icon={
                coupon.isActive ? (
                  <FiCheckCircle
            ...
            <span className="inline-flex justify-center" aria-hidden>
              {coupon.isActive ? (
                <FiCheckCircle
                  className="w-5 h-5 text-green-500 opacity-70"
                  aria-label={t("common.active")}
                />
              ) : (
                <FiXCircle
                  className="w-5 h-5 text-red-500 opacity-70"
                  aria-label={t("common.inactive")}
                />
              )}
            </span>
...
export default function Coupons() {
  ...
  const activeCoupons = (response?.data ?? []).filter(
    (c) => !(c as unknown as Record<string, unknown>).deletedBy,
  );
  const deletedCoupons = (response?.data ?? []).filter(
    (c) => (c as unknown as Record<string, unknown>).deletedBy,
  );
  ...
  const activeForTab =
    activeTab === "general" ? generalActive : perCustomerActive;
  const deletedForTab =
    activeTab === "general" ? generalDeleted : perCustomerDeleted;
          ...
          >
            <div className="p-6">
              <Alert variant="destructive">
                ...
                <AlertTitle>
                  {confirmDialog.type === "delete"
                    ? t("couponsPage.deleteTitle")
                    : t("couponsPage.restoreTitle")}
                </AlertTitle>
                <AlertDescription>
                  {confirmDialog.type === "delete"
                    ? t("couponsPage.deleteConfirm", {
                        name: confirmDialog.name ?? "",
                      })
                    : t("couponsPage.restoreConfirm", {
                        name: confirmDialog.name ?? "",
                      })}
                </AlertDescription>
              </Alert>
              <div className="flex justify-end gap-3 mt-6">
                ...
                <Button
                  variant={
                    confirmDialog.type === "delete" ? "danger" : "primary"
                  }
        ...
        <Table>
          <TableHead>
            <tr>
              ...
              <TableHeadCell>
                {t("couponsPage.displayOnClientPage")}
              </TableHeadCell>
        ...
        <>
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-100 mb-4">
              {activeTab === "general"
                ? t("couponsPage.headingGeneral")
                : t("couponsPage.headingPerCustomer")}
            </h2>
            ...
            <div className="space-y-3 md:hidden">
              {filteredActive.length === 0 ? (
                <p className="text-sm text-gray-500 dark:text-slate-400">
                  {activeTab === "general"
                    ? t("couponsPage.noGeneral")
                    : t("couponsPage.noPerCustomer")}
                </p>
              ) : (
                        ...
                        <p>
                          ...
                          {c.customerId != null &&
                            (() => {
                              ...
                              if (!cust)
                                return ` · ${t("common.idDisplay", { id: c.customerId })}`;
                      ...
                      <div className="flex justify-end gap-1 pt-2">
                        ...
                        {perm("coupons", "delete") ? (
                          <Button
                            ...
                            className="p-2 text-xs"
                            icon={<FiTrash className="w-4 h-4" />}
                            onClick={() => openConfirm("delete", c.id, c.name)}
              ...
              <Table>
                <TableHead>
                  <tr>
                    ...
                    <TableHeadCell>{t("common.restaurant")}</TableHeadCell>
                    <TableHeadCell>
                      {t("couponsPage.customerColumn")}
                    </TableHeadCell>
                    <TableHeadCell>
                      {t("couponsPage.discountColumn")}
                    </TableHeadCell>
                    <TableHeadCell>{t("couponsPage.validFrom")}</TableHeadCell>
                    <TableHeadCell>{t("couponsPage.validTo")}</TableHeadCell>
                    <TableHeadCell>
          ...
          {canSeeDeletedCoupons && deletedForTab.length > 0 && (
            <div className="mt-8">
              <h2 className="text-2xl font-semibold text-gray-600 dark:text-slate-400 mb-4">
                {activeTab === "general"
                  ? t("couponsPage.deletedGeneral")
                  : t("couponsPage.deletedPerCustomer")}
              </h2>
              <Table>
                <TableHead>
                  <tr className="bg-gray-100 dark:bg-slate-900">
                    <TableHeadCell className="text-gray-600 dark:text-slate-100">
                      {t("couponsPage.code")}
                    </TableHeadCell>
                    <TableHeadCell className="text-gray-600 dark:text-slate-100">
                      {t("couponsPage.name")}
                    ...
                    <TableHeadCell className="text-gray-600 dark:text-slate-100">
                      {t("couponsPage.validFrom")}
                    </TableHeadCell>
                    <TableHeadCell className="text-gray-600 dark:text-slate-100">
                      {t("couponsPage.validTo")}
                    </TableHeadCell>
                    <TableHeadCell className="text-gray-600 dark:text-slate-100">
                      {t("couponsPage.displayOnClientPage")}
                    </TableHeadCell>
                    <TableHeadCell className="text-gray-600 dark:text-slate-100">
                      {t("couponsPage.deletedByLower")}
                    </TableHeadCell>
                    <TableHeadCell className="text-gray-600 dark:text-slate-100">
                      {t("couponsPage.actions")}
                    </TableHeadCell>
                  </tr>
                </TableHead>
                <TableBody>
