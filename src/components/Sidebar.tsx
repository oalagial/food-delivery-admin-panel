...
export function Sidebar({ isOpen, onNavigate }: SidebarProps) {
  ...
  return (
    <aside
      className={`sidebar fixed inset-y-0 left-0 z-40 w-[240px] max-w-[80%] transform transition-transform duration-200 ease-in-out md:static md:inset-y-auto md:left-auto md:shrink-0 md:max-w-none md:transform-none md:overflow-hidden md:transition-[width] md:duration-200 md:ease-in-out ${isOpen ? 'translate-x-0 md:w-[240px]' : '-translate-x-full md:translate-x-0 md:w-0'
        }`}
